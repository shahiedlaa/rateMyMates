...
router.put(
  "/editGameweek/:weekNumber",
  checkAuth,
  TeamsController.editGameweek
);
router.put("/:teamId", checkAuth, TeamsController.updatePlayers);
router.put(
  "/addSubsequentGameweek/:teamId",
  checkAuth,
  TeamsController.addSubsequentGameweek
);
router.put(
  "/deleteGameweek/:teamId",
  checkAuth,
  TeamsController.deleteGameweek
);
router.delete(
  "/deleteOnlyGameweek/:teamId",
  checkAuth,
  TeamsController.deleteOnlyGameweek
);
